...
template_ini = INI_FILES / "test_container_prefactor_2.ini"
...
output_dir = OUTPUT_PCRGLOB / f"calibration_run_prefactor_test_24mar_night" #{run_id}

cal_start = "1949-11-01T00:00:00Z"
...
SPINUP_DAYS = 60  # number of spinup days to run before the calibration period; adjust as needed
