...
CALIBRATION_PARAMS = {
    ...
    'snowWaterHoldingCap_grass': {
        'section': 'grasslandOptions',
        'key': 'snowWaterHoldingCap',
        'bounds': (0.000001, 0.5),
        'initial': 0.1,
    },
    'groundwater_baseflow': {
        'section': 'groundwaterOptions',
        'key': 'baseflow_exponent',
        'bounds': (0.000001, 2),
        'initial': 1,
    },
...
template_ini = INI_FILES / "test_calibration.ini"
...
output_dir = OUTPUT_PCRGLOB / f"calibration_runs_overnight_14march_run{RUN_ID}"

cal_start = "1948-10-01T00:00:00Z"
...
SPINUP_DAYS = 400  # number of spinup days to run before the calibration period; adjust as needed

# CMA-ES settings
SIGMA0 = 0.2       # initial step size (20% of [0,1] range)
MAX_ITER = 8       # number of generations
