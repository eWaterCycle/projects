...
CALIBRATION_PARAMS = {
    'multiplier_for_degreeDayFactor': {
        ...
        'key': 'linear_multiplier_for_degreeDayFactor',
        'bounds': (0.5, 5),
        'initial': 1.0,
    },
...
template_ini = INI_FILES / "test_container_prefactor.ini"
forcing_dir = FORCING_PCRGLOB / LOAD_PCR / PCR_TAIL
params_dir = PCR_GLOBAL_PARAMS
bmi_image = ContainerImage("/home/avandervee3/ewatercycle_pcr_16mar.sif")
...
output_dir = OUTPUT_PCRGLOB / f"calibration_run_prefactor_test_18mar" #{run_id}

cal_start = "1949-12-01T00:00:00Z"
...
SPINUP_DAYS = 30  # number of spinup days to run before the calibration period; adjust as needed

# Per-evaluation cleanup settings.
# Keep run directories by default for debugging/reproducibility.
FORCE_GC_AFTER_RUN = True
REMOVE_RUN_DIR_AFTER_EVAL = False

# CMA-ES settings
SIGMA0 = 0.2       # initial step size (20% of [0,1] range)
MAX_ITER = 9       # number of generations
