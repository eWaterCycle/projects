...
prepared_PCRGlob_forcing = (
    FORCING_PCRGLOB  /"CMIP6"/"MPI-ESM1-2-HR"/"ssp245"/"r1i1p1f1"/"2015-2100" / "AralSea_basin" / "work/diagnostic/script"
)
...
experiment_start_date_1 = "2020-01-01T00:00:00Z"
experiment_end_date_1 = "2030-12-31T00:00:00Z"
...
BASE_OUTPUT_DIR = Path(__file__).resolve().parent / "cmip_parallel_runs"
